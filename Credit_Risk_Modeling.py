...
#Making Pipeline for seemless data transformation

def data_preprocessing_pipeline(a1_path, a2_path):
    ...
    # Identify and drop columns with excessive -99999 values in df2, 10k is my threshold
    ...
    # Remove rows with -99999 values from df2
    for col in df2.columns:
    ...
    # ANOVA test for remaining numerical columns
...
a1_path = "C:/SUFIYAN/STUDY MATERIALS/FOR CLASS/FOR CLASS/Credit Risk Modeling/data/case_study1.xlsx"
a2_path = "C:/SUFIYAN/STUDY MATERIALS/FOR CLASS/FOR CLASS/Credit Risk Modeling/data/case_study2.xlsx"
...
rf_classifier = RandomForestClassifier(n_estimators = 250, random_state=45)
...
# xgboost is giving me best result, hence I will further finetune it after applying standard scaler
...
#No improvement in metrics after scaling
...
joblib.dump(model, 'xgb_clf_model.joblib')
